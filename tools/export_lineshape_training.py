...
<p>For reference-page regeneration using the pinned dataset in <code>configs/lineshape-training.json</code>, use <code>python tools/run_model_comparison.py --protocol configs/lineshape-training.json</code>, then <code>python tools/export_lineshape_training.py</code>. Use matching fresh <code>--runs-dir</code> paths for repeated runs.</p>
